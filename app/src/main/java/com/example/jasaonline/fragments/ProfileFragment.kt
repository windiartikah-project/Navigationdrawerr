            ...
            view.btnHapusUser.setOnClickListener {
                ...
                builder.setPositiveButton("Yes"){dialog, _ ->
                    ...
                    requestCall.enqueue(object: retrofit2.Callback<DefaultResponse>{
                        ...
                        Throwable) {
                            Toast.makeText(context, "Error terjadi ketika sedang menghapus user: " +
                ...
                override fun onResponse(
                    ...
                    if(!response.body()?.error!!) {
                        ...
                        defaultResponse.let {
                            session.removeUser()
                            Toast.makeText(context, defaultResponse.message,
                    ...
                    LoginActivity::class.java)
                        ...
                        Toast.makeText(context, "Gagal menghapus user: " +
